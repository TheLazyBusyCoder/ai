...
class DrawingApp:
    ...
    def save_canvas(self):
        ...
        new_data = [row[:] for row in self.grid]  # Make a copy of the grid

        # Write the updated data back to the file with indentation for formatting
    ...
    #     print(f"Data written to {filename}.json {self.no_of_file}")

    #     # Create the directory if it doesn't exist
    #     os.makedirs('letter_data', exist_ok=True)
    #     file_path = os.path.join('letter_data', filename + ".json")
    ...
    #     # Append the new drawing data directly to the existing data list
